...
ALL_CCFLAGS += -maxrregcount=16 -std=c++11
...
stockast.o:stockast.cu
	$(EXEC) $(NVCC) -g -G $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

stockast:stockast.o
	$(EXEC) $(NVCC) -g -G $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIBRARIES)

run: build
	$(EXEC) ./stockast

clean:
	rm -f stockast stockast.o
